...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pyiron_gui-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pyiron_gui-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install pyiron_gui
```
...
It is possible to list all of the versions of `pyiron_gui` available on your platform:
...
```
pixi search pyiron_gui --channel conda-forge
```
